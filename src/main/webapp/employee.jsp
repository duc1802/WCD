...
"                                               class="from-control" name="name" required="required">
                    ...
                    <fieldset class="from-group">
                        <label>Employee email</label><input type="text" value="<c:out value="${employee.birthday}"/>
"                                               class="from-control" name="email" required="required">
                    </fieldset>
                    <fieldset class="from-group">
                        <label>Employee country</label><input type="text" value="<c:out value="${employee.address}"/>
"                                               class="from-control" name="country" required="required">
                    </fieldset>
                        <fieldset class="from-group">
                            <label>Employee country</label><input type="text" value="<c:out value="${employee.position}"/>
"                                               class="from-control" name="country" required="required">
                        </fieldset>
                        <fieldset class="from-group">
                            <label>Employee country</label><input type="text" value="<c:out value="${employee.department}"/>
"                                               class="from-control" name="country" required="required">
                        </fieldset>
